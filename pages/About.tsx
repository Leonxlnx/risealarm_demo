      ...
      <div className="bg-[#F9F9F7] pt-32 pb-24">
         ...
         <div className="max-w-[1200px] mx-auto px-6 border-t border-gray-200 pt-24 text-center">
            ...
            <div className="flex justify-center gap-4 md:gap-6">
               ...
               <a href="https://www.tiktok.com/@risealarm.app?_r=1&_t=ZP-930qe6TVnLi" target="_blank" className="flex items-center gap-3 p-4 md:px-6 md:py-4 bg-white border border-gray-200 rounded-full hover:border-black transition-colors group">
