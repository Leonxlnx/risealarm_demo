       ...
       <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
          <div className="order-2 lg:order-1">
             ...
             <Reveal delay={300} mode="slide">
                 <div className="flex flex-col sm:flex-row gap-4 mb-12">
                    ...
                    <button
                        ...
                        className="bg-black text-white rounded-lg px-4 py-2 flex items-center gap-3 hover:bg-gray-800 transition-colors opacity-80 cursor-not-allowed shadow-xl"
                    >
                       <svg aria-hidden="true" viewBox="0 0 384 512" width="24" height="24" fill="currentColor">
                    ...
                    <button
                        ...
                        className="bg-gray-100 text-gray-400 rounded-lg px-4 py-2 flex items-center gap-3 cursor-not-allowed border border-gray-200"
                    >
                       <svg aria-hidden="true" viewBox="0 0 512 512" width="24" height="24" fill="currentColor" className="grayscale opacity-50">
             ...
             <Reveal delay={400} mode="blur">
                 <div
                    className="bg-white p-6 rounded-3xl border border-gray-200 shadow-lg max-w-md transition-all duration-300"
                    aria-live="polite"
                 >
                     {status === 'success' ? (
