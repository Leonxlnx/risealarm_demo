  ...
  return (
    <div className="border-b border-gray-200">
      <button
        ...
        className={`w-full py-8 md:py-10 cursor-pointer group transition-all duration-500 ${isOpen ? 'bg-transparent' : 'hover:bg-transparent'}`}
        onClick={onClick}
      >
      ...
      <div
        ...
        className={`grid transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${isOpen ? 'grid-rows-[1fr] opacity-100 mb-8 md:mb-10' : 'grid-rows-[0fr] opacity-0 mt-0'}`}
      >
