...
const FAQItem = ({ question, answer, isOpen, onClick }: any) => {
  ...
  return (
    <div className="border-b border-gray-200">
      <button
        type="button"
        className={`w-full text-left pt-8 md:pt-10 cursor-pointer group transition-all duration-500 flex justify-between items-start md:items-center gap-6 ${isOpen ? 'pb-0' : 'pb-8 md:pb-10 hover:bg-transparent'}`}
        onClick={onClick}
