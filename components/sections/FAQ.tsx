  ...
  return (
    <div className="border-b border-gray-200">
      <button
        ...
        className={`w-full text-left pt-8 md:pt-10 group flex justify-between items-start md:items-center gap-6 bg-transparent hover:bg-transparent transition-all duration-500 ${isOpen ? 'pb-0' : 'pb-8 md:pb-10'}`}
        onClick={onClick}
      >
      ...
      <div
        ...
        role="region"
        aria-hidden={!isOpen}
        className={`grid transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${isOpen ? 'grid-rows-[1fr] opacity-100 pb-8 md:pb-10' : 'grid-rows-[0fr] opacity-0 pb-0'}`}
      >
