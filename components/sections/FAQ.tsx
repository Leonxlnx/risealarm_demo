  ...
  return (
    ...
    >
      <button
        ...
        id={headerId}
        className="w-full text-left group flex justify-between items-start md:items-center gap-6 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF6B00] focus-visible:ring-offset-2 rounded-lg"
      >
