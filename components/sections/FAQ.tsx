    ...
    <div className="border-b border-gray-200">
      <h3>
        <button
          ...
          className="w-full py-8 md:py-10 flex justify-between items-start md:items-center gap-6 text-left group focus:outline-none focus-visible:ring-2 focus-visible:ring-[#FF6B00] rounded-lg transition-colors bg-transparent hover:bg-transparent cursor-pointer"
        >
           <span className={`text-xl md:text-2xl font-bold transition-colors duration-300 leading-tight tracking-tight ${isOpen ? 'text-[#FF6B00]' : 'text-[#111] group-hover:text-gray-600'}`}>
              {question}
           </span>
      ...
      >
         <div className="overflow-hidden">
            <div className={`transition-all duration-700 ${isOpen ? 'pb-8 md:pb-10' : 'pb-0'}`}>
