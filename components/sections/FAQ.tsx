...
const FAQItem = ({ question, answer, isOpen, onClick }: any) => {
  ...
  return (
    <div 
      className={`border-b border-gray-200 py-8 md:py-10 group transition-all duration-500 ${isOpen ? 'bg-transparent' : 'hover:bg-transparent'}`}
    >
      <h3>
        <button
          type="button"
          ...
          onClick={onClick}
          className="w-full flex justify-between items-start md:items-center gap-6 cursor-pointer text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF6B00] rounded-lg"
        >
